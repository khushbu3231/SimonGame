...
// var totalColorButton=document.querySelectorAll(".btn").length;
// for(var i=0;i<totalColorButton;i++){
...
// // for(var i=0; i<userClickedPattern.length/2;i++){
// //     for(var j=userClickedPattern.length/2; j<userClickedPattern.length;j++){
// //         console.log("okay I am ready to comapare");
...
// function addAnimation(randomChosenColor){
